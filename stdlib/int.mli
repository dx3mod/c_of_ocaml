...
(** Integer values.
    ...
    representation. All operations are taken modulo 2{^ [Sys.int_size]}. They do
...
(** [shift_left x n] shifts [x] to the left by [n] bits. The result is
    unspecified if [n < 0] or [n > ]{!Sys.int_size}. *)
...
(** [shift_right x n] shifts [x] to the right by [n] bits. This is a logical
    ...
    [x]. The result is unspecified if [n < 0] or [n > ]{!Sys.int_size}. *)
